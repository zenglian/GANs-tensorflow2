...
class WGAN():
    def __init__(self, args):
        ...
        self.datasets = load_mnist_data(dataset_name=self.datasets_name, batch_size=args.batch_size, model_name="WGAN")
    ...
    def train(self, load=False):
        ...
        # if want to load a checkpoint,set load flags to be true
        if load:
        ...
        for epoch in range(start_epoch, self.epoches):
            for batch_images, _ in self.datasets:
                ...
                if step % 100 == 0:
                    print("step：{}, d_loss: {:.4f}, g_loss: {:.4F}".format(step, self.critic_loss_metric.result(),
